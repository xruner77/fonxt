        ...
        <div className="comparison-grid">
          ...
          <div className="comparison-card traditional">
            <div className="comp-header">
              <div className="comp-icon" style={{ background: 'rgba(239, 68, 68, 0.12)', color: '#ef4444' }}>
                <XCircle size={24} />
              </div>
              <div>
                <h3 className="comp-title" style={{ color: '#dc2626' }}>传统分工外包团队</h3>
          ...
          <div className="comparison-card fonxt">
            <div className="comp-header">
              <div className="comp-icon" style={{ background: 'rgba(2, 132, 199, 0.12)', color: 'var(--color-cyan)' }}>
                <CheckCircle2 size={24} />
              </div>
              <div>
                <h3 className="comp-title" style={{ color: 'var(--color-cyan)' }}>FONXT 一人全链路</h3>
                <span style={{ fontSize: '0.8rem', color: 'var(--color-cyan)', fontWeight: 500 }}>三位一体 · 快速敏捷</span>
              </div>
            </div>
